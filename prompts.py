...
def ZeroShotRulesCode():
    return  """
        Im providing a negative outcome from a {ML-system}, a set of positive counterfactual casesand the main rules inferred from the counterfactuals.
...
def ZeroShotExample(user_input = False):
    if user_input:
        return """
            A person has been classified in the negative class of {ML-system}. The data is the following:
            ----- Negative assessment outcome -----
            ...
            ----- Rules -----
            By Evaluating the counterfactuals, we obtained the following rules:
            {rules}
            ...
            ----- Example -----
            Furthermore, an expert user has said that the most important rules are: {user_input}
...
def ZeroShotExampleCode():
    return  """
    Im providing a negative outcome from a {ML-system}. A positive example in the format os a single row dataframe was created in temp_csv from the rules that are also provided. Complete the code so it counts the number of rules followed by the example.
        ...
        rules_count = #complete this code

        print(rules_count)
        ```
        """ 

def ZeroShotExampleCode2():
    return  """
...
def OneShotRules():
    return """
    Im providing a negative outcome from a {ML-system} and your task is to extract the most important observed rules based on a set of counterfactual cases. 
    Once you extracted the top rules, you should generate python code to count how many of the counterfactuals are consistent with the rule. The code should create a df with the counterfactuals provided and then check for each rule how many of them follow the rules. Order the rules. Finally, you should print the results.
    Example:
    ----- Negative assessment outcome -----
...
def OneShotExample(user_input = False):
    if user_input:
        return """
        Im providing a negative outcome from a {ML-system} and your task is to extract the most important observed rules based on a set of counterfactual cases. 
        Once you extracted the top rules, you should generate python code to count how many of the counterfactuals are consistent with the rule. The code should create a df with the counterfactuals provided and then check for each rule how many of them follow the rules. Order the rules. Finally, you should print the results.
        ...
        ----- Example -----
        Furthermore, an expert user has stated that the most important rules are: 1,2
        Given this information, provide an example in the format of a pandas dataframe that would be in the positive class. Write the code 
        ...
        ----- Example -----
        Furthermore, an expert user has stated that the most important rules are: {user_input}
        Given this information, provide an example in the format of a pandas dataframe that would be in the positive class. Write the code 
...
def OneShotExampleCode():
    ...
    return  """
    Im providing a negative outcome from a {ML-system}. A positive example in the format os a single row dataframe was created in temp_csv from the rules that are also provided. Give some code to check the number of rules followed by the example..
    Example:
